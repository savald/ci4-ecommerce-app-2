...
<div x-show="logModal" x-transition:enter="transition-opacity ease-linear duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" x-transition:leave="transition-opacity ease-linear duration-200" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" class="mx-auto fixed inset-0 flex items-center justify-center overflow-y-auto bg-black z-40 bg-opacity-25">
  <div class="p-4 w-full max-w-md h-full md:h-auto">
    ...
    <div @click.away="logModal = false" class="bg-white rounded shadow-lg dark:bg-gray-700">
      ...
      <div class="mt-3 mb-6 space-x-4 lg:px-8 flex justify-between">
      ...
      <form class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="#">
        <p class="text-sm font-semibold text-center text-gray-500 dark:text-white">or with email</p>
        <div>
          <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your email</label>
          <input type="email" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-800 text-sm rounded focus:border-indigo-500 focus:outline-none appearance-none block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="email@example.com" required>
        </div>
        <div>
          <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your password</label>
          <input type="password" name="password" id="password" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-800 text-sm rounded focus:border-indigo-500 focus:outline-none appearance-none block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
        </div>
        <div class="flex justify-between">
          <div class="flex items-start">
            <div class="flex items-center h-5">
              <input id="remember" aria-describedby="remember" type="checkbox" class="w-4 h-4 bg-gray-50 rounded border border-gray-300 focus:ring-3 focus:ring-indigo-300 dark:bg-gray-600 dark:border-gray-500 dark:focus:ring-indigo-600 dark:ring-offset-gray-800" required>
            </div>
    ...
    <div class="bg-white rounded shadow-lg dark:bg-gray-700">
      ...
      <form class="px-6 pb-4 space-y-6 lg:px-8 sm:pb-6 xl:pb-8" action="#">
        ...
        <div>
          ...
          <input type="text" name="fullname" id="fullname" class="bg-gray-50 border border-gray-300 text-gray-800 text-sm rounded focus:border-indigo-500 focus:outline-none appearance-none block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Your Name..." autofocus required>
        </div>
        <div>
