...
<section id="hero" class=" bg-white">
  <div class="max-w-7xl mx-auto p-8">
    <div class="grid grid-cols-3 gap-y-10 gap-x-6">
      ...
      <!-- Embla carousel -->
      <div class="col-start-2 col-span-2 rounded-md overflow-hidden shadow-md">
        <div class="embla">
          <div class="embla__container">
            <div class="embla__slide  h-[30rem]">
...
<!-- Product list -->
<section id="product-list" class="bg-gray-100">
      ...
      <div class="group border rounded-md bg-white transition shadow-sm hover:shadow">
        <a href="#">
          ...
          <div class="flex items-center justify-between px-3 pt-3">
            ...
            <p class="font-bold text-indigo-600">$35</p>
          </div>
        </a>
